...
namespace CaptureProgram
{
    public partial class Form1 : Form
    {
        ...
        {
            var Client = new UdpClient();
            var RequestData = Encoding.ASCII.GetBytes("shootMorteza");
            ...
            //{
                ...
                //SaveTempFile(subPath + "//" + i.ToString() + "_2.jpg", GetRequest(camera[1]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_3.jpg", GetRequest(camera[2]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_4.jpg", GetRequest(camera[3]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_5.jpg", GetRequest(camera[4]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_6.jpg", GetRequest(camera[5]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_7.jpg", GetRequest(camera[6]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_8.jpg", GetRequest(camera[7]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_9.jpg", GetRequest(camera[8]));
                //SaveTempFile(subPath + "//" + i.ToString() + "_10.jpg", GetRequest(camera[9]));
            ...
            for (int i = 1; i < 2; i++)
            {
                ...
                SaveTempFile(subPath + "//" + i.ToString() + "_1.h264", GetRequest(camera[0]));
                SaveTempFile(subPath + "//" + i.ToString() + "_2.h264", GetRequest(camera[1]));
                SaveTempFile(subPath + "//" + i.ToString() + "_3.h264", GetRequest(camera[2]));
                SaveTempFile(subPath + "//" + i.ToString() + "_4.h264", GetRequest(camera[3]));
                SaveTempFile(subPath + "//" + i.ToString() + "_5.h264", GetRequest(camera[4]));
                SaveTempFile(subPath + "//" + i.ToString() + "_6.h264", GetRequest(camera[5]));
                SaveTempFile(subPath + "//" + i.ToString() + "_7.h264", GetRequest(camera[6]));
                SaveTempFile(subPath + "//" + i.ToString() + "_8.h264", GetRequest(camera[7]));
                SaveTempFile(subPath + "//" + i.ToString() + "_9.h264", GetRequest(camera[8]));
                SaveTempFile(subPath + "//" + i.ToString() + "_10.h264", GetRequest(camera[9]));
